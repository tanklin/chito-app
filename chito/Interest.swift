...
class Interest
{
    ...
    static func createInterests() -> [Interest]
    {
        return [
            ...
            Interest(title: "It's Tea Time", description: " ", featuredImage: UIImage(named: "sort_teatime")!),
            Interest(title: "Dinner with Family", description: " ", featuredImage: UIImage(named: "sort_dinner")!),
            Interest(title: "TGI.Friday Cheer!!!", description: " ", featuredImage: UIImage(named: "sort_beer")!)
        ]
    }
}
