...
#define DEFAULT_TITLE_FONT [UIFont fontWithName:@"HelveticaNeue-Bold" size:30.0]
#define DEFAULT_LABEL_COLOR [UIColor whiteColor]
#define DEFAULT_BG_COLOR [UIColor clearColor]
#define DEFAULT_DESCRIPTION_FONT [UIFont fontWithName:@"HelveticaNeue-Light" size:18.0]
#define DEFAULT_TITLE_IMAGE_Y_POSITION 160.0f
#define DEFAULT_TITLE_LABEL_Y_POSITION 200.0f
#define DEFAULT_DESCRIPTION_LABEL_Y_POSITION 160.0f
